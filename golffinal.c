        ...
        */
        ...
        while (1) {                 // Loop forever
            ...
            while(1) { //wind  test loop
                ...
                projected_yards_left = 0;

                if(winddir > 145 && winddir <= 215){
                    while(windspeed >= 5){
                        windspeed = windspeed - 5;
                        projected_ yards_left = yards_left*0.1 + yardsleft;
                    }
                }
                else if( (winddir >= 290 && winddir <= 0) || (winddir > 0 && winddir <35) ){
                    while(windspeed >= 5){
                        windspeed = windspeed - 5;
                        projected_ yards_left = yardsleft - yards_left*0.05;
                    }
                }
